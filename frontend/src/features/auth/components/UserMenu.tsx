  ...
  return (
    <div className={styles.bar}>
      ...
      {/*
        ...
        Để ý là nút này KHÔNG cần biết refresh token. `logoutAction` tự đọc nó từ
        cookie phía server — đúng như nó phải vậy, vì cookie `httpOnly` thì trình
        duyệt có muốn đọc cũng không được.
      */}
